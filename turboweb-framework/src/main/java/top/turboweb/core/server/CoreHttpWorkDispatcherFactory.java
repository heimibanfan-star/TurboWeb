...
public class CoreHttpWorkDispatcherFactory implements HttpWorkDispatcherFactory {
    ...
    private AutoDestructSentinel.EnableScheduler enableScheduler;
    ...
    @Override
    public void enableRequestSerial() {
        this.enableScheduler = new AutoDestructSentinel.EnableScheduler(512, 1024);
    }

    @Override
    public void enableRequestSerial(int initCapacity, int maxCapacity) {
        this.enableScheduler = new AutoDestructSentinel.EnableScheduler(initCapacity, maxCapacity);
    }
}
