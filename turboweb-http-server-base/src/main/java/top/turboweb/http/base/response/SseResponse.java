package top.turboweb.http.base.response;
...
public class SseResponse extends DefaultHttpResponse implements InternalCallResponse {
     ...
     */
    public void setSseCallback(Flux<String> flux, Function<Throwable, String> errorHandler, Consumer<ConnectSession> onFinally) {
