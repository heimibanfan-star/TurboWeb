...
import org.turboweb.core.http.request.HttpContent;
import org.turboweb.core.http.request.HttpInfoRequest;
import org.turboweb.exception.TurboHttpParseException;
...
public class HttpInfoRequestPackageUtils {
    ...
    static {
        ...
        bodyInfoParseFunctions.put("multipart/form-data", HttpInfoRequestPackageUtils::doParseFormBodyInfo);
    }
